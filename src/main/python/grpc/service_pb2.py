...
try:
    ...
    class BetaRosBridgeServiceStub(object):
        ...
        def reportTwistData(self, request_iterator, timeout, metadata=None, with_call=False, protocol_options=None):
            raise NotImplementedError()
    ...
    def beta_create_RosBridgeService_server(servicer, pool=None, pool_size=None, default_timeout=None,
        ...
        method_implementations = {
            ('rosbridge_service.RosBridgeService', 'reportTwistData'): face_utilities.stream_unary_inline(
                servicer.reportTwistData),
    ...
    def beta_create_RosBridgeService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
        ...
        cardinalities = {
            'reportTwistData': cardinality.Cardinality.STREAM_UNARY,
